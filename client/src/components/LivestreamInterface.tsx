...
const MOCK_NOTES = [
  {
    ...
    content:
      "I don't have information about who was the best Call of Duty Mobile player in Nigeria as of March 2025.",
...
export default function LivestreamInterface({
  ...
  const [currentNote, setCurrentNote] = useState<(typeof MOCK_NOTES)[0] | null>(
    null,
  );
  ...
  const handleSaveNote = useCallback(() => {
    ...
    const newNote = {
      id: `note-${Date.now()}`,
      title:
        noteLines[0].substring(0, 50) + (noteLines[0].length > 50 ? "..." : ""),
                    ...
                    <div className="p-3">
                      ...
                      <div className="space-y-1">
                        {MOCK_RECENTS.map((question, index) => (
                          <div key={index}>
                            <div className="flex justify-between items-center p-2 rounded-[8px] hover:bg-zinc-800/50 group transition-colors">
