...
export default function LandingPage() {
  ...
  return (
    <div className="landing-page flex flex-col min-h-screen bg-[#121212]">
      ...
      {/* Hero Section */}
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-10 md:py-20 text-center z-10 relative">
        <h1 className="hero-heading text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-8 max-w-4xl animate-fadeInUp">
        ...
        <p className="hero-text text-[#A5A5A5] max-w-lg mx-auto mb-12 text-base md:text-lg animate-fadeInUp delay-100">
        ...
        <button 
          ...
          className="button-hover-effect flex items-center gap-2 rounded-full px-7 py-3.5 bg-[#DCC5A2] text-[#121212] font-medium hover:bg-[#C6B190] transition-all shadow-md animate-fadeInUp delay-200"
        >
          <Download size={18} />
        ...
        {animationComplete && (
          <div className="mt-16 animate-fadeInUp delay-300">
            <ArrowDown className="w-6 h-6 text-[#DCC5A2] animate-bounce mx-auto opacity-60" />
          </div>
        )}
      </main>

      {/* AI Chat Panel */}
      <div className="fixed bottom-12 left-1/2 transform -translate-x-1/2 max-w-2xl w-[95%] md:w-[85%] lg:w-[75%] xl:w-[65%] mx-auto px-4 z-20 animate-fadeInUp delay-300">
